...
-   `df`: the joined dataset df is a 822 × 11 dataset with variable
...
``` r
mr_trash_wheel = read_excel("202207 Trash Wheel Collection Data.xlsx", sheet="Mr. Trash Wheel", range = cell_cols("A:N"))|>
  janitor::clean_names()|>
